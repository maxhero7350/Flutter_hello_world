...
class ThemeProvider extends foundation.ChangeNotifier {
  ...
  // STEP 03: 取得當前主題資料
  cupertino.CupertinoThemeData get currentTheme {
    // STEP 03.01: 根據深色模式設定返回對應主題
    return _isDarkMode ? _darkTheme : _lightTheme;
  }

  // STEP 04: 淺色主題配置
  cupertino.CupertinoThemeData get _lightTheme {
    // STEP 04.01: 返回淺色主題配置
    return const cupertino.CupertinoThemeData(
      brightness: cupertino.Brightness.light,
      primaryColor: cupertino.CupertinoColors.systemBlue,
      scaffoldBackgroundColor: cupertino.CupertinoColors.systemBackground,
      barBackgroundColor: cupertino.CupertinoColors.systemBackground,
      textTheme: cupertino.CupertinoTextThemeData(
        primaryColor: cupertino.CupertinoColors.label,
      ),
    );
  }

  // STEP 05: 深色主題配置
  cupertino.CupertinoThemeData get _darkTheme {
    // STEP 05.01: 返回深色主題配置
    return const cupertino.CupertinoThemeData(
  ...
  // STEP 11: 根據系統亮度更新主題
  void updateFromSystemBrightness(cupertino.Brightness brightness) {
    // STEP 11.01: 檢查是否使用系統主題
    if (_useSystemTheme) {
      // STEP 11.02: 根據系統亮度設定深色模式
      bool shouldBeDark = brightness == cupertino.Brightness.dark;
      // STEP 11.03: 檢查是否需要更新
