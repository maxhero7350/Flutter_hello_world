...
class LoadingSpinner extends cupertino.StatelessWidget {
  ...
  cupertino.Widget build(cupertino.BuildContext context) {
    ...
    return cupertino.Container(
        // STEP 02: 設定全畫面尺寸
        width: cupertino.MediaQuery.of(context).size.width,
        height: cupertino.MediaQuery.of(context).size.height,
        // STEP 03: 設定背景遮罩顏色
        color: backgroundColor ?? cupertino.CupertinoColors.black.withValues(alpha: 0.5),
        // STEP 04: 建立中央載入內容
          ...
          child: cupertino.Container(
            ...
            decoration: cupertino.BoxDecoration(
              ...
              borderRadius: cupertino.BorderRadius.circular(
                containerRadius ?? constants.Constants.BORDER_RADIUS_LARGE,
              ),
              // STEP 07: 設定陰影效果
              boxShadow: shadows ?? [
                cupertino.BoxShadow(
            ...
            child: cupertino.Column(
              ...
              children: [
                ...
                cupertino.CupertinoActivityIndicator(
                  ...
                  color: spinnerColor ?? cupertino.CupertinoColors.activeBlue,
                ),
                // STEP 10: 載入訊息間距
